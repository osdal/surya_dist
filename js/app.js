    ...
    function menuBodyWayUp() {
        mainMenuItems.forEach((menu => {
            menu.addEventListener("click", (() => {
                ...
                if (menu.querySelector(".icon-menu-clicked")) menu.querySelector(".menu__body").classList.toggle("z-index-10");
            }));
        }));
    }
    document.addEventListener("DOMContentLoaded", (() => {
            ...
            menu.forEach((element => {
                element.addEventListener("click", (function() {
                    menu.forEach((item => {
                        ...
                        if (element.querySelector(".sub-menu").style.maxHeight != 0) element.querySelector(".sub-menu").style.maxHeight = 0;
                    }));
                    if (element.classList != "active") {
                        element.classList.add("active");
                        if (element.querySelector(".sub-menu")) smoothIncreaseMaxHeight(0, 0, element.querySelector(".sub-menu"));
                    }
                }));
            }));
        }
        ...
        function smoothIncreaseMaxHeight(initialValue, interval, subMenu) {
            ...
            const intervalIdentifier = setInterval((() => {
                ...
                if (presentValue >= 100) clearInterval(intervalIdentifier);
            }), interval);
        }
